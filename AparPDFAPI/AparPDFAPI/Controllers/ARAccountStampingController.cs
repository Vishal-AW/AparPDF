...
{
    public class ARAccountStampingController : ApiController
    {
        [HttpGet]
        [Route("api/PDFImageAR/GetPDFGenrateAccount/{LID}/{AssetCode}")]
        public string GetPDFMyAction(string LID,string AssetCode)
        {
                                ...
                                if (data != null)
                                {
                                    ...
                                    PdfContentByte pbover = stamper.GetOverContent(n);
                                        ...
                                        for (int y = 1; y < reader.NumberOfPages + 1; y++)
                                        {
                                            ...
                                            ColumnText.ShowTextAligned(pbover, Element.ALIGN_LEFT, new Phrase(new Chunk("Asset Code " + AssetCode, lable)), 445, 770, 0);
