...
{
    public class testPurchaseController : ApiController
    {
        [HttpGet]
        [Route("api/testPDFImageNew/GetPDFGenrate/{ActionName}/{LoginName}/{EmailID}/{Comments}/{PONumber}/{PODisplayNo}/{UserType}/{letterheadType}")]
