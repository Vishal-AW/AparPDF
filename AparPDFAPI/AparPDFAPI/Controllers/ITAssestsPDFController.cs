...
{
    public class ITAssestsPDFController : ApiController
    {

        [HttpGet]
        [Route("api/ITAssetPDFImage/GenerateITAssetPDF/{ActionName}/{LoginName}/{EmailID}/{Comments}/{PONumber}/{PODisplayNo}/{UserType}")]
        public string GetPDFMyAction(string ActionName, string LoginName, string EmailID, string Comments, string PONumber, string PODisplayNo, string UserType)
        {
            ...
            using (var contextimage = new ClientContext("https://aparindltd.sharepoint.com"))
            {
                ...
                using (var context = new ClientContext("https://aparindltd.sharepoint.com/ITAssetRequisition"))
                {
                    ...
                    var subsitelistdata = context.Web.Lists.GetByTitle("ITAssetDocument");
                    ...
                    query1.ViewXml = "<View><Query><Where><Eq><FieldRef Name='RequisitionNo' LookupId='TRUE'/><Value Type='Lookup'>" + POnum + "</Value></Eq></Where></Query></view>";
                    ...
                    foreach (var oListItem1 in listitem1)
                    {
                       ...
                       // var Rowno = oListItem1["RowNumber"].ToString();
                        ...
                        var Exetension = Exttype.ToLower();
                        if (Exetension != "pdf")
                        {
                            ...
                            using (MemoryStream ms = new MemoryStream())
                            {
                                ...
                                var docimg = "/ITAssetRequisition/ITAssetDocument/" + docnm + "";
                                var docimg1 = "/ITAssetRequisition/ITAssetDocument/" + Filenm + ".pdf";
                                ...
                                string documentListName = "ITAssetDocument";
                                string documentListURL = "https://aparindltd.sharepoint.com/ITAssetRequisition/ITAssetDocument/";
                                //string documentName = "11111_Airnet.pdf";


                                Web web = context.Web;
                                Microsoft.SharePoint.Client.List list = web.Lists.GetByTitle("ITAssetDocument");
                                ...
                                uploadFile.ListItemAllFields["RequisitionNo"] = POnum;
                               // uploadFile.ListItemAllFields["RowNumber"] = Rowno;
                                // uploadFile.ListItemAllFields["ExpVoucherNo"] = 27;
                                uploadFile.ListItemAllFields.Update();
                                context.ExecuteQuery();

                                path = "/ITAssetRequisition/ITAssetDocument/" + Filenm + ".pdf";
                        ...
                        else
                        {
                            ...
                            path = "/ITAssetRequisition/ITAssetDocument/" + docnm + "";
