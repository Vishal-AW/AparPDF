                    ...
                    using (var context = new ClientContext(ConfigurationManager.AppSettings["ARSite"]))
                    {
                        ...
                        foreach (var oListItem1 in listitem1)
                        {
                         ...
                         //   var FileTypename = oListItem1["FileType"].ToString();
                            ...
                            //PO_X[0] = Xvalue; PO_Y[0] = B_P + 71;
                            //PO_X[1] = Xvalue; PO_Y[1] = B_P + 26;
                            //PO_X[2] = Xvalue; PO_Y[2] = B_P + 17;
                            //PO_X[3] = Xvalue; PO_Y[3] = B_P + 8;
                            //PO_X[4] = Xvalue; PO_Y[4] = B_P + 8;
                            //PO_X[5] = Xvalue; PO_Y[5] = noticline;

                            PO_X[0] = Xvalue; PO_Y[0] = B_P + 79;
                            PO_X[1] = Xvalue; PO_Y[1] = B_P + 35;
                            PO_X[2] = Xvalue; PO_Y[2] = B_P + 23;
                            PO_X[3] = Xvalue; PO_Y[3] = B_P + 16;
                            PO_X[4] = Xvalue; PO_Y[4] = B_P + 8;
                            PO_X[5] = Xvalue; PO_Y[5] = noticline;
