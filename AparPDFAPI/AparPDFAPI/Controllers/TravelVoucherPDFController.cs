...
{
    public class TravelVoucherPDFController : ApiController
    {

        [HttpGet]
        [Route("api/TravelPDFImage/GenerateTravelPDF/{ActionName}/{LoginName}/{EmailID}/{Comments}/{PONumber}/{PODisplayNo}/{UserType}")]
        public string GetPDFMyAction(string ActionName, string LoginName, string EmailID, string Comments, string PONumber, string PODisplayNo, string UserType)
        {
            ...
            using (var contextimage = new ClientContext("https://aparindltd.sharepoint.com"))
            {
                ...
                using (var context = new ClientContext("https://aparindltd.sharepoint.com/TravelVoucher"))
                {
                    ...
                    var subsitelistdata = context.Web.Lists.GetByTitle("TravelDocuments");
                    ...
                    foreach (var oListItem1 in listitem1)
                    {
                        ...
                        if (Exttype != "pdf")
                        {
                            ...
                            using (MemoryStream ms = new MemoryStream())
                            {
                                ...
                                var docimg = "/TravelVoucher/TravelDocuments/" + docnm + "";
                                var docimg1 = "/TravelVoucher/TravelDocuments/" + Filenm + ".pdf";
                                ...
                                //sigimage1.SetAbsolutePosition(593, 700);
                                //sigimage1.ScaleAbsolute(iTextSharp.text.PageSize.A4.Width, iTextSharp.text.PageSize.A7.Height);
                                ...
                                string documentListName = "TravelDocuments";
                                string documentListURL = "https://aparindltd.sharepoint.com/TravelVoucher/TravelDocuments/";
                                //string documentName = "11111_Airnet.pdf";


                                Web web = context.Web;
                                Microsoft.SharePoint.Client.List list = web.Lists.GetByTitle("TravelDocuments");
                                ...
                                //uploadFile.ListItemAllFields["ExpVoucherNo"] = 81;
                                uploadFile.ListItemAllFields.Update();
                                context.ExecuteQuery();

                                path = "/TravelVoucher/TravelDocuments/" + Filenm + ".pdf";
                        ...
                        path = "/TravelVoucher/TravelDocuments/" + docnm + "";
                        ...
                        using (System.IO.MemoryStream mStream = new System.IO.MemoryStream())
                        {
                            if (data != null)
                            {
                                ...
                                if (UserType == "InternalAuditor")
                                {
                                    ...
                                    //DispayPO
                                    //ColumnText.ShowTextAligned(pbover, Element.ALIGN_LEFT, new Phrase(DispayPO), 200, 170, 0);
                                    //ColumnText.ShowTextAligned(pbover, Element.ALIGN_LEFT, new Phrase(Comments), 200, 160, 0);
                                    //ColumnText.ShowTextAligned(pbover, Element.ALIGN_LEFT, new Phrase(ActionName), 200, 145, 0);
                                    //iTextSharp.text.Image sigimage = iTextSharp.text.Image.GetInstance(imgarray);
                                    //sigimage.SetAbsolutePosition(200, 100);
                                    //pbover.AddImage(sigimage);
                                    //ColumnText.ShowTextAligned(pbover, Element.ALIGN_LEFT, new Phrase(User), 200, 900, 0);
                                ...
                                if (UserType == "Accountant")
                                {
                                    ...
                                    //DispayPO
                                    //ColumnText.ShowTextAligned(pbover, Element.ALIGN_LEFT, new Phrase(DispayPO), 400, 170, 0);
                                    //ColumnText.ShowTextAligned(pbover, Element.ALIGN_LEFT, new Phrase(Comments), 400, 160, 0);
                                    //ColumnText.ShowTextAligned(pbover, Element.ALIGN_LEFT, new Phrase(ActionName), 400, 145, 0);
                                    //iTextSharp.text.Image sigimage = iTextSharp.text.Image.GetInstance(imgarray);
                                    //sigimage.SetAbsolutePosition(400, 100);
                                    //pbover.AddImage(sigimage);
                                    //ColumnText.ShowTextAligned(pbover, Element.ALIGN_LEFT, new Phrase(User), 400, 900, 0);
